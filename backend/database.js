...
async function initDatabase() {
    try {
        ...
        // Safely add cadence and metadata columns to leads table
        try {
            ...
            await client.query(`ALTER TABLE leads ADD COLUMN IF NOT EXISTS website_metadata TEXT`);
        } catch (e) {
            console.error('Erro ao adicionar colunas de cadência/metadata em leads:', e.message);
        }
